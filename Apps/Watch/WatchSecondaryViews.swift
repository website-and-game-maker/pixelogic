...
struct WatchAboutView: View {
    ...
    private let paras: [Para] = [
        Para(icon: "square.grid.3x3.fill", title: "What is Pixelogic?",
        ...
        Para(icon: "laurel.leading", title: "Scoring lives on the phone",
             body: "On the wrist, play is casual: you just track which puzzles you've completed. The full Pixelogic Score (0–1,600) is a phone and web concern."),
        Para(icon: "hand.raised.fill", title: "Private & offline",
             body: "No accounts, no analytics, no network. Everything stays on this watch, and deleting the app deletes it. Pixelogic runs fully standalone — no phone required."),
        Para(icon: "sparkles", title: "Built entirely by AI",
             body: "Everything in Pixelogic — even the idea itself — was conceived and written by Claude (Anthropic's AI) working in Claude Code. There is no human author: the engine, the puzzles, the art, the tests and this text are all AI-made."),
    ]
